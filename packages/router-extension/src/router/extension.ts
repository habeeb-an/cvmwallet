import { Router, MessageSender, Result, EnvProducer, WalletError } from '@owallet/router';
...
export class ExtensionRouter extends Router {
  ...
  protected async onMessageHandler(message: any, sender: MessageSender): Promise<Result> {
    try {
