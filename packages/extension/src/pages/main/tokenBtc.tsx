...
export const TokensBtcView: FunctionComponent<{
  ...
  const { chainStore, priceStore, queriesStore, accountStore, keyRingStore } = useStore();
  ...
  const totalBalance = useMemo(() => {
    ...
    return '';
  }, [token.coinDecimals, chainStore.current.chainId, account?.bech32Address, exchangeRate, balanceBtc]);
