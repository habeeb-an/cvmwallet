...
describe('Test ADR-36 Amino Sign Doc', () => {
  ...
  it('Make ADR-36 Amino sign doc and validate', () => {
    let signDoc = makeADR36AminoSignDoc('osmo1ymk637a7wljvt4w7q9lnrw95mg9sr37yatxd9h', new Uint8Array([1, 2, 3]));
    ...
    signDoc = makeADR36AminoSignDoc('osmo1ymk637a7wljvt4w7q9lnrw95mg9sr37yatxd9h', 'test');
  ...
  it('Verify ADR-36 Amino sign doc', () => {
    ...
    expect(verifyADR36AminoSignDoc('osmo', signDoc, pubKey.toBytes(), signature)).toBe(true);
    ...
    expect(verifyADR36Amino('osmo', signer, new Uint8Array([1, 2, 3]), pubKey.toBytes(), signature)).toBe(true);
    ...
    expect(verifyADR36Amino('osmo', signer, new Uint8Array([1, 2]), pubKey.toBytes(), signature)).toBe(false);
  });
});
